...
Next.js 15 · TypeScript · Tailwind v4 · GSAP (ScrollTrigger + Flip) · Lenis · `ogl` WebGL glitch shader.
...
```
public/hero/portrait.jpg               ← 3840×2160 (16:9) hero portrait
...
- **Glitch shader** → `components/gl/shaders/glitch.frag` (uniform contract in `CLAUDE.md`)
